package com.jaimedantas.fiiztaxauthenticator.ultils;
...
public class CalculationEngine {
    ...
    public static BigDecimal divide8(BigDecimal arg1, BigDecimal arg2){
        return arg1.divide(arg2, 8,  RoundingMode.HALF_UP).setScale(8, RoundingMode.HALF_UP);
    }
    ...
    public static BigDecimal multiply8(BigDecimal arg1, BigDecimal arg2){
        return arg1.multiply(arg2).setScale(8, RoundingMode.HALF_UP);
    }
